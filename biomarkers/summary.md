# Urine Biomarker Detection Summary
**Focus:** Spectrophotometry (UV-Vis, NIR, fluorescence, light scattering) + EIS from urine samples, reagent-free where possible.
...
> **Important:** None of these ions have direct UV-Vis-NIR chromophores or fluorescence. All direct optical methods require reagents (colorimetric complexation). Reagent-free sensing relies on indirect NIR (water structure perturbation) or electrochemical methods.
