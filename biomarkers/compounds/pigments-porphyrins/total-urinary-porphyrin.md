...
Composite measure of heme pathway by-products in urine. The Soret band (~400 nm) and intense red fluorescence (Em ~595–630 nm) make [[total-urinary-porphyrin|porphyrins]] uniquely suited to spectroscopic detection. Closely related to [[porphobilinogen]]. See [[signatures]] and [[optical-properties]] for spectral reference data.

> [!TIP]
> All [[total-urinary-porphyrin|porphyrins]] share the Soret band (~400 nm) and red fluorescence (Ex 400 nm / Em 618 nm). This makes fluorescence the most sensitive detection modality, with sub-nanomolar LOD achievable without derivatisation.
...
| Property | Value |
|---|---|
| **Name** | Total Urinary [[total-urinary-porphyrin\|Porphyrins]] (TUP) |
...
TUP is a composite measure of all [[total-urinary-porphyrin|porphyrins]] excreted in urine: primarily **uroporphyrin** (8-COOH), **heptacarboxylporphyrin** (7-COOH), **hexacarboxylporphyrin** (6-COOH), **pentacarboxylporphyrin** (5-COOH), and **coproporphyrin** (4-COOH). All share the characteristic **Soret absorption band** (~400 nm) and red fluorescence (Em ~595–630 nm).

### Molecules Not to Be Confused With

| Molecule | MW (g/mol) | Key Difference |
|---|---|---|
| **Porphobilinogen ([[porphobilinogen\|PBG]])** | 226.23 | Monopyrrole precursor; no Soret band or fluorescence |
...
[[total-urinary-porphyrin|Porphyrins]] are synthesised in all nucleated cells. Major urinary [[total-urinary-porphyrin|porphyrins]] arise from:

1. ALA synthase → ALA (rate-limiting)
2. ALA dehydratase → [[porphobilinogen]] ([[porphobilinogen|PBG]])
3. [[porphobilinogen|PBG]] deaminase → hydroxymethylbilane
...
Urinary [[total-urinary-porphyrin|porphyrins]] are oxidised by-products: uroporphyrinogen and coproporphyrinogen spontaneously oxidise to uroporphyrin and coproporphyrin, which cannot be utilised for heme synthesis. Major production sites: **bone marrow** (erythropoiesis) and **liver**.

**Exogenous:** No dietary contribution. Dietary chlorophyll (a Mg-porphyrin) is metabolised differently and does not contribute to urinary [[total-urinary-porphyrin|porphyrins]].

### Biological Roles

- **Primary:** Porphyrinogens are essential heme precursors.
- **Secondary:** Free [[total-urinary-porphyrin|porphyrins]] are waste products. They are **phototoxic** — absorb light at Soret band ~400 nm, generating ROS → tissue damage in cutaneous porphyrias.
...
No significant hepatic catabolism; [[total-urinary-porphyrin|porphyrins]] are excreted intact.

### Clinical Levels

| Compartment | Reference Range |
|---|---|
| **Total urinary [[total-urinary-porphyrin\|porphyrins]] (24-h)** | <300 µg/day (some labs: <200 µg/day) |
...
| **Acute intermittent porphyria (AIP)** | Moderate coproporphyrin; [[porphobilinogen\|PBG]] markedly elevated | Abdominal pain, neuropsychiatric; ~1:20,000 |
...
Present in small amounts normally (<300 µg/day total). Coproporphyrin is dominant in health. Form: free (non-metal-complexed), oxidised [[total-urinary-porphyrin|porphyrins]] in anionic forms. Intensely coloured (red-purple) and fluorescent. [[total-urinary-porphyrin|Porphyrins]] do not form urinary crystals.
...
Optimal specimen: **24-hour urine** protected from light (opaque containers). Stabilise at pH 6–7; store at 2–8 °C. [[total-urinary-porphyrin|Porphyrins]] are photodegradable — light protection is essential.

### Interferences

| Interference | Effect | Mechanism |
|---|---|---|
| **Light exposure** | False decrease | Photodegradation of [[total-urinary-porphyrin\|porphyrins]] |
...
| **Bacterial contamination** | False decrease | Bacterial metabolism of [[total-urinary-porphyrin\|porphyrins]] |
| **Dietary beetroot/food dyes** | False positive (visual) | Red pigments mimic porphyrin fluorescence |

### Spectroscopic Detection

**UV-Vis (Soret band):** The defining feature of [[total-urinary-porphyrin|porphyrins]]. Intense Soret (B) band at **~398–405 nm** (ε ≈ 3–5 × 10⁵ M⁻¹cm⁻¹) and weaker Q bands at ~500, 530, 565, 620 nm. Dual-wavelength (Soret peak vs baseline at 430 nm) for TUP quantification. LOD ~5–10 µg/L in acidified urine extracts.

**Fluorescence:** [[total-urinary-porphyrin|Porphyrins]] are **intensely fluorescent** — most sensitive detection modality.
...
| 4 | Christensen et al. (1977) — Rapid assay of urinary [[total-urinary-porphyrin\|porphyrins]] by dual-wavelength spectrophotometry. Clin Chim Acta. |
| 5 | Lang et al. (2018) — Spectrophotometric quantification of urinary [[total-urinary-porphyrin\|porphyrins]] and [[porphobilinogen\|PBG]]. J Biomed Opt. https://journals.spiedigitallibrary.org/journalArticle/Download?fullDOI=10.1117/1.JBO.23.5.055006 |
| 6 | Mayo Clinic Labs — [[total-urinary-porphyrin\|Porphyrins]] Quantitative Urine (PQNU). https://neurology.testcatalog.org/show/PQNU |
...
[total-urinary-porphyrin|porphyrins]: total-urinary-porphyrin.md "Total Urinary Porphyrin"
[porphobilinogen]: porphobilinogen.md "Porphobilinogen"
[total-urinary-porphyrin\|Porphyrins]: total-urinary-porphyrin.md "Total Urinary Porphyrin"
[porphobilinogen\|PBG]: porphobilinogen.md "Porphobilinogen"
[total-urinary-porphyrin|Porphyrins]: total-urinary-porphyrin.md "Total Urinary Porphyrin"
[porphobilinogen|PBG]: porphobilinogen.md "Porphobilinogen"
[total-urinary-porphyrin\|porphyrins]: total-urinary-porphyrin.md "Total Urinary Porphyrin"
