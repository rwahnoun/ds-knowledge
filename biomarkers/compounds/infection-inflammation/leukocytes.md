...
Leukocytes is the medical synonym for **White Blood Cells ([[white-blood-cells|WBC]])**. This sheet focuses on the **leukocyte esterase (LE) enzyme** as the specific dipstick-detectable biomarker, while cellular aspects are covered in the White Blood Cells sheet. LE is an enzyme released from neutrophil granules during degranulation or cell lysis; it persists in urine even after [[white-blood-cells|WBC]] disintegration, making it more sensitive than microscopy in aged specimens. See [[datascience/spectroscopy-biomarkers]] for clinical urinalysis context.
...
| **Other names** | [[white-blood-cells\|WBC]] esterase, granulocyte esterase |
...
| **Significance** | Indirect marker of pyuria — detected even after [[white-blood-cells\|WBC]] lysis |
...
- **Diagnostic pyuria marker:** In urine, LE activity serves as an indirect indicator of [[white-blood-cells|WBC]] presence.
...
- LE is released into urine as [[white-blood-cells|WBC]] degranulate or lyse.
...
| **Urine [[white-blood-cells\|WBC]] count** | <5 [[white-blood-cells\|WBC]]/HPF; <25 [[white-blood-cells\|WBC]]/µL |
...
- Very early infection ([[white-blood-cells|WBC]] not yet recruited)
...
**Form in urine:** Dissolved **enzyme** (protein) released from [[white-blood-cells|WBC]].
...
1. **Dipstick leukocyte esterase (standard):**
   ...
   - **LOD:** ~10–25 [[white-blood-cells|WBC]]/µL equivalent.
...
3. **Flow cytometry ([[white-blood-cells|WBC]] counting, indirect):**
   - Counts intact [[white-blood-cells|WBC]], not LE activity. See White Blood Cells sheet for details.

### Optimal Urine Type for Measurement

- **Midstream clean-catch** — standard.
- LE remains positive **even in old specimens** (enzyme persists after [[white-blood-cells|WBC]] lysis) — advantage over microscopy.
...
For pyuria detection, **manual microscopy** remains the reference ([[white-blood-cells|WBC]] count/HPF). The LE dipstick is the primary **screening** tool. Combined LE + nitrite has better predictive value for UTI than either alone.
...
| **Vaginal contamination** | False positive | [[white-blood-cells\|WBC]] from vaginal secretions |
...
- **Fluorogenic esterase substrates:** Non-fluorescent ester substrates (e.g., fluorescein diacetate, 4-methylumbelliferyl acetate) cleaved by LE to release fluorescent product.
  - Fluorescein: Ex 490 / Em 520 nm. LOD: ~1 [[white-blood-cells|WBC]] equivalent/µL.
  - 4-Methylumbelliferone: Ex 360 / Em 450 nm. LOD: ~0.5 [[white-blood-cells|WBC]]/µL.
- **Calcein-AM (live cell staining):** Intracellular esterases convert calcein-AM to fluorescent calcein (Ex 495 / Em 515 nm). Detects intact, viable [[white-blood-cells|WBC]] only.

#### Raman Detection

No specific Raman detection methods for LE enzyme in urine. [[white-blood-cells|WBC]] cellular Raman spectra are discussed in the White Blood Cells sheet.
...
- LOD: ~5 [[white-blood-cells|WBC]] equivalent/µL.
- **Screen-printed electrodes:** Disposable, paper-based electrochemical LE sensors. LOD: ~10 [[white-blood-cells|WBC]]/µL.

### Other Detection Technologies

1. **Smartphone-based LE dipstick reading:** Camera + app analyses colour of LE pad. LOD: comparable to dipstick (~10–25 [[white-blood-cells|WBC]]/µL). Improved objectivity.

2. **Microfluidic LE sensors:** Integrated fluorogenic substrate reaction + optical detection. LOD: ~1–5 [[white-blood-cells|WBC]]/µL.
...
|---|---|---|---|---|
| **Dipstick LE** | ~10–25 [[white-blood-cells\|WBC]]/µL | 550 nm violet dye | None | Rapid, cheap |
| **Automated reflectance** | ~10 [[white-blood-cells\|WBC]]/µL | 550 nm | None | Objective |
| **Fluorogenic substrate** | ~0.5–1 [[white-blood-cells\|WBC]]/µL | Ex 360–490/Em 450–520 nm | Substrate | More sensitive |
| **Chromogenic** | ~0.1 U/L | 405 nm | Substrate | Quantitative |
| **Electrochemical** | ~5–10 [[white-blood-cells\|WBC]]/µL | +0.3–0.5 V | Substrate | Disposable |
| **Microscopy** | ~1 [[white-blood-cells\|WBC]]/HPF | 400× | Centrifugation | Gold standard |
...
| 3 | PMC — [[white-blood-cells\|WBC]] and Nitrite in UTI Diagnosis. https://pmc.ncbi.nlm.nih.gov/articles/PMC8253458/ |
