...
Riboflavin is a water-soluble B vitamin and the direct precursor of FMN and [[fad|FAD]], the essential flavin coenzymes. It is one of the **most intensely fluorescent** natural compounds (Ex 450 nm / Em 525 nm, quantum yield ~25%), making it the dominant contributor to the yellow-green autofluorescence of urine. Excess riboflavin is rapidly excreted in urine.
...
| **[[fad\|FAD]]** | C₂₇H₃₃N₉O₁₅P₂ | 785.55 | Adenylated FMN; lower quantum yield (quenched by adenine) |
...
- **Primary:** Coenzyme precursor. Converted to FMN and [[fad|FAD]], required by ~75 flavoproteins for redox reactions in energy metabolism, fatty acid oxidation, drug metabolism, and antioxidant defence (glutathione reductase).
- **Antioxidant:** Via glutathione reductase ([[fad|FAD]]-dependent).
- **Migraine prophylaxis:** High-dose riboflavin (400 mg/day) reduces migraine frequency.

### Elimination Pathway

Absorbed in small intestine via RFVT transporter. Converted to FMN and [[fad|FAD]] in cells. Excess free riboflavin and metabolites (7-alpha-hydroxyriboflavin, lumiflavin) excreted in urine. **Renal excretion** is the primary route; both glomerular filtration and active tubular secretion contribute. Urinary riboflavin increases proportionally with intake above tissue saturation.
...
| **Erythrocyte [[fad\|FAD]]** | 300–600 nmol/L |
...
|---|---|---|---|---|
| **HPLC-fluorescence (gold standard)** | C18 RP-HPLC separates riboflavin from FMN and [[fad\|FAD]] | Ex 450 / Em 520–525 nm | ~1–5 nmol/L | Specific; protect from light |
...
| **FMN/[[fad\|FAD]]** | Spectral overlap | Same isoalloxazine fluorophore |
...
**Fluorescence:** Direct fluorescence at **Ex 450 / Em 525 nm**. LOD ~1 nM. Quantum yield ~25%. EEM fluorescence with chemometrics resolves riboflavin from [[fad|FAD]] and other fluorophores (LOD ~5 nM). Time-resolved: riboflavin lifetime ~4.7 ns (vs [[fad|FAD]] ~2.3 ns). Sample prep: dilution; protect from light.
...
- Riboflavin is a major interferent in EEM/fluorescence-based urinary analysis; spectral deconvolution from [[fad|FAD]], FMN, [[nadh|NADH]], and [[tryptophan]] requires validated chemometric models
