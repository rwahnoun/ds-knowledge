...
Physical property measured on the Jimini platform as a proxy for hydration and renal concentrating ability. See [[jimini-signal-processing]] for NIR-based estimation approaches and [[optical-properties]] for spectral context.
