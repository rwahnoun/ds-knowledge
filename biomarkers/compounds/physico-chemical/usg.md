...
tags:
  ...
  - type/reference
  - status/complete
  - class/physico-chemical
  - clinical/hydration
  - modality/nir
  - modality/refractometry
  - presence/normal
  - subclass/concentration-property
date: 2026-04-19
status: complete
type: reference
...
subclass: concentration-property
presence: normal
parent: "[[biomarkers/compounds/physico-chemical/index|physico-chemical]]"
---
# Urine Specific Gravity

Physical property measuring the concentration of dissolved solutes as a ratio to water density. A rapid proxy for [[osmolality]]. Measured clinically by refractometry (gold standard) or dipstick (ionic SG). See [[jimini-signal-processing]] and [[optical-properties]] for NIR-based estimation context.
...
[osmolality]: osmolality.md "Osmolality"
...
[creatinin|creatinine]: ../metabolites/creatinin.md "Creatinine"
[uric-acid|uric acid]: ../metabolites/uric-acid.md "Uric Acid"
[glucose\|Glucose]: ../metabolites/glucose.md "Glucose"
