...
**Endogenous:** Reflects all solutes in urine — urea (from protein catabolism), electrolytes (Na, K, Cl, NH4⁺), creatinine, uric acid, organic acids, and phosphate. The kidney regulates osmolality via ADH-mediated water reabsorption (collecting duct aquaporin-2) and the countercurrent mechanism.
...
| **Calculated osmolality** | 2(Na + K) + Urea + Glucose (mmol/L) | N/A | Only an estimate; misses unmeasured osmoles |
