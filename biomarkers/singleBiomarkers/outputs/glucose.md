...
**Primary role:**
- **Universal energy substrate:** Glucose is metabolised via glycolysis, TCA cycle, and oxidative phosphorylation to produce ATP. Brain and RBCs are obligate glucose users.
...
- Glucose freely filtered at glomerulus (~180 g/day at normal blood glucose).
...
| Condition | Glucose Pattern | Key Symptoms |
|---|---|---|
...
| Urinary Glucose | Possible Causes | Prevalence |
|---|---|---|
...
1. **Dipstick glucose oxidase (most common):**
   - **Principle:** Glucose oxidase converts glucose + O₂ → gluconic acid + H₂O₂. H₂O₂ + peroxidase oxidises chromogen (o-toluidine or potassium iodide) → colour change.
...
2. **Hexokinase method (quantitative, lab):**
   - **Principle:** Hexokinase phosphorylates glucose (ATP → ADP); G-6-P + NAD⁺ (via G6PDH) → 6-phosphogluconate + NADH.
   - **Detection:** NADH absorbance at **340 nm**.
   - **LOD:** ~1 mg/dL (~0.06 mmol/L).
   - **Advantages:** Reference method; highly specific.

3. **Glucose oxidase-peroxidase (GOD-POD, quantitative):**
   - **Principle:** Same as dipstick but solution-phase with spectrophotometric readout.
   - **Detection:** 505 nm (Trinder colour) or 340 nm (NADH-coupled).
   - **LOD:** ~1–5 mg/dL.
...
**Hexokinase method** (NADH at 340 nm) is the clinical chemistry reference. GOD-POD is the common automated alternative. Both on Roche Cobas, Siemens, Abbott platforms. CV: 2–4%.
...
| **Bacteria (delayed)** | False negative | Consume glucose |
...
- **UV-Vis:** Glucose has no chromophore; no direct UV-Vis absorption above 200 nm. All methods require enzymatic or chemical conversion to generate a chromophore.
- **NIR:** Glucose has overtone/combination bands at ~1600 nm, ~2100–2270 nm. Used for non-invasive blood glucose monitoring (challenging). In urine, PLS models can detect glucose at LOD ~10 mg/dL with NIR.

#### Fluorescence Detection

- Glucose is non-fluorescent. Indirect methods:
- **Enzymatic (NADH production):** Hexokinase + G6PDH produces NADH (Ex 340 / Em 460 nm). LOD: ~0.5 mg/dL.
...
- **Glucose-binding protein (FRET sensors):** Conformational change upon glucose binding alters FRET. Various Ex/Em depending on pair.
...
| **Hexokinase** | ~1 mg/dL | 340 nm (NADH) | None | Reference, precise |
...
| # | Citation |
|---|---|
| 1 | StatPearls — Peroxidase-Coupled Glucose Method. https://www.ncbi.nlm.nih.gov/books/NBK594277/ |
...
| 6 | PubChem — Glucose, CID 5793. https://pubchem.ncbi.nlm.nih.gov/compound/5793 |

## Gaps

- NIR detection of glucosuria in urine is challenging due to overlap with urea, creatinine, and water bands; validated multivariate models across diverse urine matrices are lacking.
