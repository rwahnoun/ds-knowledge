...
|---|---|
| **Name** | Tryptophan |
| **Other names** | L-Tryptophan, Trp, W |
...
| Condition | Tryptophan Pattern | Key Symptoms |
|---|---|---|
...
|---|---|---|
| **Protein fluorescence** | Spectral overlap | Tryptophan residues in urinary proteins |
| **Tyrosine** | Partial spectral overlap | Ex 275 / Em 303 nm |
| **Bacterial metabolism** | Decreased Trp | Bacteria convert Trp to indole |
| **Light** | Photodegradation | Indole ring photosensitive |

### Spectroscopic Detection

**UV-Vis:** Tryptophan absorbs at **280 nm** (ε ~5,500 M⁻¹cm⁻¹, indole ring) and 220 nm. LOD ~5 µmol/L by direct UV; interfered by proteins in urine.

**Fluorescence:** Intrinsic indole fluorescence at **Ex 280 nm / Em 348 nm** is tryptophan's defining optical property. Quantum yield ~13% (free in water). LOD ~0.05 µmol/L in clean solutions; ~1–5 µmol/L in urine (matrix interference). EEM fluorescence with chemometrics resolves Trp from tyrosine, NADH, and riboflavin (LOD ~1 µmol/L). FLIM: Trp lifetime ~3.1 ns (free).
...
**Voltammetry:** Tryptophan indole ring oxidised at **+0.7–0.9 V vs Ag/AgCl** on carbon electrodes. LOD ~0.1–1 µmol/L on modified electrodes (graphene, MIPs, BDD). Interference from uric acid and ascorbic acid; DPV provides best selectivity.
...
| # | Reference |
|---|---|
| 1 | PubChem — L-Tryptophan, CID 6305. https://pubchem.ncbi.nlm.nih.gov/compound/6305 |
...
| 4 | PMC — Tryptophan metabolism in health and disease (kynurenine pathway) |

---

## Gaps

- EEM-based tryptophan quantification in complex urine requires spectral deconvolution from riboflavin, NADH, tyrosine, and urinary proteins
