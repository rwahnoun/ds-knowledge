...
| **CAS number** | 58-68-4 |
| **PubChem CID** | 928 |
| **Appearance** | White to yellow powder; solutions are colourless (NAD+) or fluorescent (NADH) |
...
- Free NADH is unstable in acidic conditions (t1/2 ~30 min at pH 4).
...
|---|---|
| **Intracellular NADH** | 100-400 uM |
| **Blood NAD+ total** | ~20-40 uM |
...
NADH itself is not a standalone clinical biomarker. Its fluorescence contributes to urinary autofluorescence patterns studied in research contexts for:
...
No routine clinical assays measure urinary NADH. It is a research biomarker detected by autofluorescence.
...
- **UV absorption:** NADH absorbs at **340 nm** (epsilon ~6,220 M-1cm-1). NAD+ absorbs at 260 nm but not 340 nm. The 340 nm band is diagnostic for the reduced form.
  - LOD: ~1 uM by direct UV.
  - Sample prep: None (direct measurement of fresh urine).

#### Fluorescence Detection

This is the primary detection modality for NADH.

- **Intrinsic fluorescence:** **Ex 340 nm / Em 460 nm** (blue fluorescence). Quantum yield ~2%.
  - LOD: ~0.1-1 uM in buffer; ~5-10 uM in urine (matrix quenching).
...
- **Sample prep:** Fresh, pH-neutral urine; protect from light.
...
- SERS: Potentially LOD ~1-10 uM. Few studies on urinary NADH specifically.
...
- LOD: ~0.1-1 uM on nanostructured electrodes.
- **Interference:** Ascorbic acid, uric acid oxidise at similar potentials.

### Other Detection Technologies

1. **Enzymatic cycling assays:** NAD+/NADH quantified by lactate dehydrogenase cycling with colourimetric or fluorimetric endpoint. LOD: ~10 nM. Measures total NAD pool.
...
|---|---|---|---|---|
| **UV absorption** | ~1 uM | 340 nm | None | Direct, simple |
| **Fluorescence** | ~0.1-1 uM | Ex 340/Em 460 nm | None (fresh) | Primary method |
| **Electrochemical** | ~0.1-1 uM | +0.1-0.3 V (modified) | Buffer | Real-time |
