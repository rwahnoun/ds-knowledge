...
1. **Dipstick nitroprusside (Legal) test:**
   - **Principle:** Sodium nitroprusside (nitroferricyanide) reacts with AcAc in alkaline conditions → purple colour. Does **NOT detect BHB**.
...
3. **Enzymatic BHB assay (laboratory):**
   - **Principle:** BHB + NAD⁺ (BHB dehydrogenase) → AcAc + NADH. NADH measured at 340 nm.
   - **Detection:** 340 nm.
   - **LOD:** ~0.05 mmol/L.
...
- **Enzymatic NADH (340 nm):** See clinical assay. LOD: ~0.05 mmol/L.
...
- **NADH fluorescence (enzymatic):** BHB dehydrogenase + NAD⁺ → NADH (Ex 340 / Em 460 nm). LOD: ~0.01 mmol/L.
...
- **BHB dehydrogenase biosensor:** Amperometric detection of NADH production at +0.3 V (mediator: Meldola Blue, prussian blue). LOD: ~10 µM.
...
| **Enzymatic BHB (lab)** | ~0.05 mmol/L | 340 nm (NADH) | None | Quantitative |
| **NADH fluorescence** | ~0.01 mmol/L | Ex 340/Em 460 nm | Enzyme | Very sensitive |
