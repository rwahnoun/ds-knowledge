...
| **Creatine phosphate** | C₄H₁₀N₃O₅P | 211.11 | Energy storage molecule in muscle; dephosphorylation yields creatinine |
| **Urea** | CH₄N₂O | 60.06 | Different nitrogen waste product; from amino acid catabolism, not muscle |
...
**Increased serum creatinine (decreased GFR):**
...
| Condition | Creatinine Pattern | Key Symptoms |
|---|---|---|
...
| Urinary Creatinine | Possible Causes | Prevalence |
|---|---|---|
...
3. **HPLC (reference method):**
   - **Principle:** Reversed-phase or ion-exchange HPLC with UV detection at **234 nm** (creatinine absorption).
   - **LOD:** ~0.01 mg/dL.
...
4. **IDMS (isotope dilution mass spectrometry):**
   - **Principle:** Gold-standard reference method for creatinine calibration.
   - **LOD:** <0.001 mg/dL.
...
|---|---|---|
| **Glucose (Jaffe)** | Positive bias | Reacts with alkaline picrate |
