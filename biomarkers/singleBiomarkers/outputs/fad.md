...
| **Other names** | FAD, flavin coenzyme |
...
|---|---|---|---|
| **Riboflavin (vitamin B2)** | C₁₇H₂₀N₄O₆ | 376.36 | Precursor of FAD/FMN; similar fluorescence; the dominant urinary fluorophore |
| **FMN (flavin mononucleotide)** | C₁₇H₂₁N₄O₉P | 456.34 | Intermediate between riboflavin and FAD; also fluorescent |
| **NADH** | C₂₁H₂₉N₇O₁₄P₂ | 665.44 | Different coenzyme; fluorescence at 340/460 nm (not 450/525 nm) |
| **FADH₂ (reduced FAD)** | C₂₇H₃₅N₉O₁₅P₂ | 787.56 | Reduced form; NOT fluorescent |
...
**Primary role:**
- **Electron carrier:** FAD/FADH₂ is a prosthetic group for succinate dehydrogenase (Complex II), acyl-CoA dehydrogenases, xanthine oxidase, monoamine oxidase, D-amino acid oxidase, and ~75 other flavoproteins.

**Secondary roles:**
- **Antioxidant systems:** Glutathione reductase requires FAD.
- **Metabolic imaging marker:** FAD/NADH fluorescence ratio ("optical redox ratio") used in research for tissue metabolic state assessment.

### Catabolism and Elimination Pathway

- FAD-bound flavoproteins are degraded by lysosomal proteases; FAD is hydrolysed to FMN and then riboflavin.
- Riboflavin is the primary urinary excretion product (freely filtered, partially reabsorbed via tubular secretion).
- Urinary riboflavin (not FAD per se) is the dominant yellow-green fluorescent species.
...
**Increased urinary riboflavin/FAD fluorescence:**
...
| Condition | FAD/Riboflavin Pattern | Key Symptoms |
|---|---|---|
| **Ariboflavinosis (B2 deficiency)** | Low urinary riboflavin, low erythrocyte FAD | Angular cheilitis, glossitis, anaemia |
| **Multiple acyl-CoA dehydrogenase deficiency (MADD)** | FAD-responsive variant | Metabolic acidosis, hypoglycaemia, myopathy |
...
2. **Erythrocyte glutathione reductase activity coefficient (EGRac):**
   - **Principle:** Functional test for riboflavin/FAD status; ratio of enzyme activity with/without added FAD.
...
**HPLC-fluorescence (Ex 450 / Em 520 nm)** for urinary riboflavin/FAD. EGRac for functional status.
...
| **Other urinary fluorophores** | Spectral overlap | Porphyrins, 4-pyridoxic acid |
