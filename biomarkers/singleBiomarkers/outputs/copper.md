...
|---|---|
| **Name** | Copper |
| **Other names** | Cu, Cu2+, cupric ion |
| **Chemical formula** | Cu²⁺ (predominant biological form) |
| **Atomic weight** | 63.55 g/mol |
| **CAS number** | 7440-50-8 |
| **PubChem CID** | 23978 |
| **Appearance** | Colourless to blue-green in solution (Cu2+ complexes) |
...
| **Zinc (Zn2+)** | Zn²⁺ | 65.38 | Another essential trace metal; competes with Cu absorption |
| **Iron (Fe2+/Fe3+)** | Fe | 55.85 | Different transition metal; different metabolic roles |
...
**Secondary roles:**
- **Iron metabolism:** Ceruloplasmin oxidises Fe2+ to Fe3+ for transferrin loading.
...
- Urinary copper excretion is normally very low (<40 ug/day) -- Cu is protein-bound (ceruloplasmin, albumin) and not freely filtered.
...
|---|---|
| **Serum copper** | 70-140 ug/dL (11-22 umol/L) |
| **Serum ceruloplasmin** | 20-50 mg/dL |
| **Urinary copper (24-h)** | <40 ug/day (<0.6 umol/day) |
| **Urinary Cu (Wilson disease)** | >100 ug/day (often >200 ug/day) |
| **Post-penicillamine urinary Cu** | >1600 ug/day diagnostic for Wilson |
| **Hepatic copper** | <50 ug/g dry weight (normal); >250 ug/g (Wilson) |
...
|---|---|---|
| **Wilson disease** | Low ceruloplasmin, high urine Cu (>100 ug/day), high hepatic Cu | Liver disease, neuropsychiatric symptoms, Kayser-Fleischer rings; 1:30,000 |
...
**Should it be normally present?** In **trace amounts** only (<40 ug/day). Most copper is protein-bound and not filtered.

**Normal urinary levels:** <40 ug/day (<0.6 umol/day).
...
|---|---|---|
| **>100 ug/day** | Wilson disease, chelation therapy | Wilson: ~1:30,000 |
| **<10 ug/day** | Normal or Menkes disease | -- |

**Solubility:** Cu2+ salts generally soluble. No urinary crystal issues.
...
1. **Flame or graphite furnace AAS:**
   ...
   - **LOD:** ~0.5 ug/L (GFAAS); ~5 ug/L (flame AAS).
...
- **UV-Vis colorimetric (bathocuproine, 484 nm):** LOD ~1 ug/dL.
- **Cu2+ d-d transitions:** Very weak absorption at ~600-900 nm (blue-green); not useful for trace analysis.

#### Fluorescence Detection

- Cu2+ is a fluorescence quencher (paramagnetic d9). Indirect approaches:
- **Turn-off probes:** Fluorescent chelators quenched by Cu2+ (e.g., calcein: Ex 490/Em 515 nm). LOD: ~0.1 umol/L.
- **Turn-on probes:** Cu2+-triggered dequenching or reaction-based probes. Various Ex/Em. LOD: ~0.01-0.1 umol/L.
- **Quantum dots (CdTe):** Cu2+ quenches QD fluorescence. Ex 350/Em 540 nm. LOD: ~5 nM.

#### Raman Detection

- Cu2+ (monatomic ion) has no Raman modes. Not directly detectable.
- **Cu complexes** with organic ligands have Raman-active modes.

#### FTIR Detection

- Not applicable for Cu2+ ion detection.
...
- **Anodic stripping voltammetry (ASV):** Cu is deposited on electrode at -0.4 V, then stripped (oxidised) at ~+0.05 V vs Ag/AgCl. Peak current proportional to Cu concentration.
  - LOD: ~0.1-1 ug/L (ppb level).
  - **Electrode:** Mercury film (HMDE), bismuth film, or carbon.
  - **Advantages:** Very sensitive, inexpensive, field-deployable.
- **Potentiometric Cu-ISE:** LOD ~0.01 umol/L.

### Other Detection Technologies

1. **Total reflection XRF (TXRF):** LOD ~0.1 ug/L. Multi-element, no digestion needed.
2. **Neutron activation analysis (NAA):** LOD ~0.01 ug/L. Ultimate reference. Limited access.
3. **Paper-based colorimetric:** Dithizone or bathocuproine on paper. LOD: ~50 ug/L.
...
|---|---|---|---|---|
| **GFAAS** | ~0.5 ug/L | 324.7 nm absorption | Acid-washed | Reference |
| **ICP-MS** | ~0.01 ug/L | m/z 63/65 | Dilution | Multi-element, ultimate |
| **Colorimetric (BCS)** | ~10 ug/L | 484 nm | Reduction | Simple |
| **ASV** | ~0.1 ug/L | Strip at +0.05 V | Deposition | Sensitive, cheap |
| **QD fluorescence** | ~5 nM | Ex 350/Em 540 nm | Probe | Sensitive |
| **Cu-ISE** | ~0.01 umol/L | Potentiometric | None | Real-time |
