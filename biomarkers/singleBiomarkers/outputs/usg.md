...
**Endogenous:** Reflects net effect of all dissolved solutes — products of metabolism (urea, creatinine, uric acid, electrolytes, organic acids, proteins). Controlled by countercurrent mechanism and ADH-mediated aquaporin-2 water reabsorption.
...
|---|---|---|
| **Glucose (>1 g/dL)** | Falsely high SG (refractometer) | High-MW solute; dipstick unaffected (non-ionic) |
