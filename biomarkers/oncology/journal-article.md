...
Cancer alters urinary metabolism in characteristic ways. The Warburg effect raises lactate and shifts the NADH/FAD redox ratio; the kynurenine pathway distorts urinary tryptophan/kynurenine; pterin and porphyrin elevations accompany malignancy.
...
|------------|-----------|---------|-------------------|
| Tryptophan / Kynurenine | 275–295 nm | 340–360 nm | Melanoma, bladder |
| NADH | 340 nm | 460 nm | Multiple (Warburg effect) |
| FAD | 450 nm | 525 nm | Multiple (metabolic redox) |
| Pterins (neopterin) | 365 nm | 450 nm | Bladder, immune activation |
| Porphyrins | 405 nm | 630 nm | Bladder, colorectal |
| 5-HIAA | ~275 nm (UV abs.) | — | Carcinoid/neuroendocrine |

Multi-excitation EEM fingerprinting combined with ML has reached **94% screening accuracy for endometrial cancer** (Kalinowska et al., 2024), and statistically significant discrimination of bladder cancer from controls (Jałocha-Bratek et al., 2025). Tryptophan-related autofluorescence at 295 nm excitation is significantly elevated in early-stage melanoma (Štrumfa et al., 2021).
...
| 20 | Tryptophan autofluorescence | Melanoma | Reagent-free fluorescence | Fluorescence Ex 295/Em 340 | µM range | — | Clinical (n>100) |
...
| 23 | NADH/FAD ratio | Multiple (Warburg) | FLIM / bulk fluorescence | Fluorescence Ex 340/460 + 450/525 | µM–mM | — | Research (cell-level) |
| 24 | Porphyrins | Bladder, CRC | Reagent-free fluorescence | Fluorescence Ex 405/Em 630 | µM range | — | Candidate |
...
|-----------|--------------|----------|---------|-----------|
| Tryptophan autofluorescence | ★★★★★ | N/A | **Excellent** | Direct match: 275 nm LED → 340 nm emission on C12; reagent-free. Melanoma and bladder cancer correlation. |
...
3. Urinary autofluorescence is sensitive to confounders (diet, hydration, medications, infections) that mandate creatinine normalisation and multivariable modelling.
...
2. Build calibrated machine-learning models on the device's native 4-LED × 2-sensor channel space, with explicit handling of creatinine, hydration and medication confounders.
...
| 9 | Štrumfa I et al. Tryptophan-related fluorescence of urine and melanoma. *IJMS* 2021;22(4):1884 | 10.3390/ijms22041884 |
...
| 23 | Alam SR et al. NADH, FAD and tryptophan FLIM in prostate cancer cells. *Sci Rep* 2017;7:10856 | 10.1038/s41598-017-10856-3 |
...
- Urinary autofluorescence requires creatinine normalisation and multivariable modelling to account for confounders (diet, hydration, medications, infections).
