...
> **Device:** Pen-sized spectrophotometer for liquid analysis (urine biomarkers)  
...
## White LED Deep-Dive — Best for Spectrophotometry / Metrology
...
**If zero UV emission is the top priority** (e.g., to completely suppress autofluorescence from the white source), Nichia Optisolis is the safer bet — Nichia explicitly specifies "UV emission essentially non-existent." The SunLike violet pump at ~405 nm does emit a small amount in the 400–420 nm near-UV range; whether this causes issues depends on the optical design and detector sensitivity below 420 nm.

**If you need coverage beyond 700 nm** (into the far-red for completeness), the Yuji APS 3030 extends to ~730 nm — useful if the C12880MA sensor (340–850 nm) or AS7343 (to 1000 nm) is being used and you want some red/far-red illumination.

### Metrology-Grade White LED Sources (Non-SMD)

For **calibration and validation** (not for the device itself):

| Source | Type | Spec | Price | Use |
|--------|------|------|-------|-----|
| **Gigahertz-Optik BN-LLSF-2P** | Calibration standard lamp | CIE L41 reference spectrum (CIE 251:2023) | ~€500+ | Photometer calibration |
| **Labsphere Spectra FT** | 15/32-channel tunable LED engine | 400–700 nm (VIS), 380–1000 nm (VIS-NIR) | ~$5,000+ | Spectral calibration of sensors |
| **Yuji NormLite** | CIE compliant standard light source | CRI 99, SAI >85%, D50/D65 | $599 | Visual inspection, color grading |

These are bench equipment, not SMD components — useful for characterizing and calibrating the pen device, not for building into it.
...
| File | Contents |
|------|----------|
| [leds.md](leds.md) | Detailed LED review — all wavelengths with specs, sourcing, design notes |
| [sensors.md](sensors.md) | Spectral sensors, NIR detectors, EIS frontends — STM32 integration |
| [suppliers.md](suppliers.md) | Distributor coverage, pricing, lead times, sourcing strategy |
| [datasheets/](datasheets/) | Downloaded manufacturer datasheets (PDF) |
| **overview.md** (this file) | Summary tables, white LED deep-dive, quick selection guide |
...
| Yuji VTC Series | [yujiintl.com](https://www.yujiintl.com/full-spectrum-white-led-vtc-series/) |
...
| Gigahertz-Optik BN-LLSF-2P | [gigahertz-optik.com](https://www.gigahertz-optik.com/en-us/product/bn-llsf-2p/) |
| CIE 251:2023 LED Reference Spectrum | [cie.co.at](https://www.cie.co.at/publications/led-reference-spectrum-photometer-calibration) |
| Labsphere Spectra FT | [sphereoptics.de](https://sphereoptics.de/en/product/spectra-ft-fine-tunable-vis-nir-spectral-calibration-sources/) |
